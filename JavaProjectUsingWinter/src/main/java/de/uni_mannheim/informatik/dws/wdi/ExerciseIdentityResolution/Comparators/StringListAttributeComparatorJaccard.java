...
public class StringListAttributeComparatorJaccard<T extends Matchable> implements Comparator<T, Attribute> {
    ...
    public StringListAttributeComparatorJaccard(Function<T, List<String>> attributeExtractor) {
