...
public class DataFusion_Main_Species {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new MovieXMLReader().loadFromXML(new File("data/input/endangered_species.xml"), "/Animals_And_Plants/Species", ds1);
        ds1.printDataSetDensityReport();

        FusibleDataSet<Movie, Attribute> ds2 = new FusibleHashedDataSet<>();
        new MovieXMLReader().loadFromXML(new File("data/input/biodiversity.xml"), "/Animals_And_Plants/Species", ds2);
        ds2.printDataSetDensityReport();

        FusibleDataSet<Movie, Attribute> ds3 = new FusibleHashedDataSet<>();
        new MovieXMLReader().loadFromXML(new File("data/input/wd_species.xml"), "/Animals_And_Plants/Species", ds3);
        ...
        correspondences.loadCorrespondences(new File("data/correspondences/biodiversity_endangeredSpecies_correspondences.csv"), ds1, ds2);
        ...
        new SpeciesXMLReader().loadFromXML(new File("data/goldstandard/gold.xml"), "/movies/movie", gs);
