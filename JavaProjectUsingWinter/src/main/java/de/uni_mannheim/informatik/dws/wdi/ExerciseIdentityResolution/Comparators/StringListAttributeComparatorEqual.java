...
public class StringListAttributeComparatorEqual<T extends Matchable>implements Comparator<T, Attribute>{
	...
	public StringListAttributeComparatorEqual(Function<T, List<String>> attributeExtractor){
