...
public class StringEvaluationRuleJaccard extends EvaluationRule<Species, Attribute> {

	SimilarityMeasure<String> sim = new TokenizingJaccardSimilarity();
	private final Function<Species, String> valueGetter;

	public StringEvaluationRuleJaccard(Function<Species, String> valueGetter) {
