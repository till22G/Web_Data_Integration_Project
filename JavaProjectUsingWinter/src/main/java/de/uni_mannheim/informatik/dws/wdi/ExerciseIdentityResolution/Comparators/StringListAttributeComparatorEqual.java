...
public class StringListAttributeComparatorEqual<T extends Matchable> extends AbstractAttributeComparator<T, List<String>> {

    private static final long serialVersionUID = 1L;
    private EqualsSimilarity<String> sim = new EqualsSimilarity<String>();

    public StringListAttributeComparatorEqual(Function<T, List<String>> attributeExtractor, String attributeName) {
